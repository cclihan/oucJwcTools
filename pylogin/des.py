...
def base64(string):
    import base64
    a = string.encode('GBK')  #对str进行编码
    b = base64.b64encode(a)  #进行base64加密
    c = b.decode('GBK')    #对结果解码
    return c
...
"""
    ...
    a = execjs.compile(source)
    key = a.call('strEnc',data,key1)
    return key 
